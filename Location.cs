...
class Location    //This represents one healthcare location (like a hospital )
{
    ...
    public RegionEnum BelongsToRegion;     // Field to store which region this location belongs to

    public Location(string name, RegionEnum region) // Constructor: runs automatically when we create a new Location
    {
